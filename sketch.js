  ...
  function setup() {
    ...
    nextbuttonsprite=createSprite(width/2,(height/2)+50,60,30);
    nextbuttonsprite.addImage("def",nextbuttonimg);
    nextbuttonsprite.scale=0.3;
    
    likesprite=createSprite(500,(height/2)-40,60,30);
    likesprite.addImage("der",likeimg);
    likesprite.scale=0.1;
  
    neutralsprite=createSprite(700,(height/2)-40,60,30);
    neutralsprite.addImage("ref",neutralimg);
    neutralsprite.scale=0.09;
  
    dislikesprite=createSprite(900,(height/2)-40,60,30);
    dislikesprite.addImage("reg",dislikeimg);
    dislikesprite.scale=0.09;
  
    q1Sprite = createSprite((width/2)+20,(height/2)-200,100,30);
  ...
  function draw(){
    ...
    function startSlide(){
          ...
          text("Hello Student, Welcome to Career Councellor",370,(height/2)-200);
          text("Let's explore your area of interests!",450,(height/2)-100);
          text("You'll get your results by the end end of Quiz!",450,(height/2)-50);
